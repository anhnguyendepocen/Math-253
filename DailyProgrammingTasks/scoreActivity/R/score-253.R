...
#'
#' This function is specifically designed for the programming activities in Math 253
#'
#' @param day. A single number, e.g. 1, 2, 17. The day of the activity.  This identifies which test
...
score253 <- function(day) {
  ...
  test_file <- paste0("DailyProgrammingTasks/Day-",day,"-Test-Statements.R")
