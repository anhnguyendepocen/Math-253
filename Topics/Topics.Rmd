...
#. Theory assignment. 
    ...
    * ISL §3.7, problems 3 and 4.  
    Add your answers to `[ID]-theory.Rmd` from Week 1. Put in appropriate headers to distinquish between weeks and the problems within a week.  You'll be adding your theory answers to this document for the rest of the semester.
