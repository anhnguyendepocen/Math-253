...
Game: Predict the results of the [recent election in Catalonia](http://www.bbc.com/news/world-europe-34372548), in terms of the number of seats won by parties which campaigned for a mandate for independence. (Actual result: 72/135)  
...
2. Suppose you know something about the contestants.    
    ...
    * Tony Dorca from Hispanic Studies
