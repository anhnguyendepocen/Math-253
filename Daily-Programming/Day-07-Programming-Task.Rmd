...
1. Create an object `vals` containing 10 random values selected from an exponential distribution with rate $1/100$.  You can use `rexp()` for this.  Check your values to make sure they are plausible.  If an event happens at a rate of $1/100$, for instance the so-called 100-year storm, you expect the interval between events to be something like 100.
...
source("Day-07-Test-Statements.R")
```
