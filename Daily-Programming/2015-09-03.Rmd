...
`paste("Today is", date())`.  Your command should be such as to create a string with the correct date on any day in the future that the script will be evaluated.
