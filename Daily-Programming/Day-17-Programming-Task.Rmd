...
The printed version of the tree gives the deviance of each node.  For both `ctree_pure` and `rtree_pure`, annotate the graph of the tree with the deviance of each node.
...
* Create a vector `nterminal` that is `1:8`
