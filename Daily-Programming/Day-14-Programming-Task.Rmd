...
Install the `glmnet` package.^[You need do this only once, so don't put it into your script.  Instead, your script should contain only the commands to load the already installed packages.]
...
This is a data table about the expression of 12 genes and their possible relationship to the expression of a phenotype. The variable `Phenotypes` will be the response in your model.
